    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return _models["default"].OrderDetail.findAll({
            include: [{
              ...
              attributes: ["mainImage", "productName"]
            }],
            where: {
              orderId: orderId
            }
        ...
        case 10:
          ...
          console.error("Error reading order details:", _context.t0);
          return _context.abrupt("return", {
...
var createOrderDetails = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(orderList) {
    var orderDetails;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          _context2.next = 3;
          return _models["default"].OrderDetail.bulkCreate(orderList);
        case 3:
          orderDetails = _context2.sent;
          if (!orderDetails) {
            _context2.next = 6;
            break;
          }
        ...
        case 9:
          ...
          console.error("Error creating order details:", _context2.t0);
          return _context2.abrupt("return", {
            EM: "Create order details failed",
            EC: "-1",
            DT: _context2.t0
  ...
  return function createOrderDetails(_x3) {
